...
def build_and_export(
    ...
    two_vol = geompy.MakePartition(
        [Pipe_1, Cut_1], [], [], [], geompy.ShapeType["SOLID"], 0, [], 0
    )
    ...
    axial_edges = [
        e for e in all_edges if geompy.BasicProperties(e)[0] > tube_radius * 2
    ]
    ...
    # --- Mesh ---
    mesh_name = "one_vol_{}_{:.2f}_{:.2f}".format(tube_radius, bend_radius, length)
...
if __name__ == "__main__":
    ...
    print(
        "--- tube_r={} bl_t={} bend_r={} length={} ---".format(
