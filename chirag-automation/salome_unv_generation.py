...
def build_and_export(tube_radius, bend_radius, length, unv_dir,
    ...
    n_segments   : int    - number of 1D segments
    growth_rate  : float  - segment growth rate
    ...
    Mesh_1.Segment().NumberOfSegments(n_segments, growth_rate, [])
...
# # ---------------------------------------------------------------------------
# # Entry point — edit parameters here or call build_and_export() directly
# # from your automation script after importing this file
# # ---------------------------------------------------------------------------
if __name__ == '__main__':
    tube_r  = float(os.environ.get('TUBE_R',  2))
    bend_r  = float(os.environ.get('BEND_R',  10))
    length  = float(os.environ.get('LENGTH',  40))
    unv_dir = os.environ.get('UNV_DIR', '/home/ckhurana/salome/mesh_exports/UNV')
